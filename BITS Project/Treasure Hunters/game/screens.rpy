...
screen preferences():
    ...
    imagemap:
        ...
        hotspot (132, 543, 85, 42) action ShowMenu("load")
        hotspot (227, 544, 76, 39) action ShowMenu("save")
        hotspot (314, 547, 72, 39) action Help()
        hotspot (480, 546, 74, 37) action Quit()
        hotspot (389, 547, 77, 35) action MainMenu()
        hotspot (558, 546, 103, 39) action Return()
