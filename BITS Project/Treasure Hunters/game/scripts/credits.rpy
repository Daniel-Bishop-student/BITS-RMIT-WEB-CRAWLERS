...
label credits:
    ...
    scene black
    with dissolve
    show cred at Move((0.5, 4.5), (0.5, 0.0), credits_speed, repeat=False, bounce=False, xanchor="center", yanchor="bottom")
