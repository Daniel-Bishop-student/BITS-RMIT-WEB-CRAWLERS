label scene7a:
    ...
    benji surprised "%(harry_name)s there’s too many!"
    slim proud "%(benji_name)s is right! You must retreat %(harry_name)s. You must not let the transporter fall into Killsalot’s hands."
    penny sad "Use the transporter %(harry_name)s! Get us out of here!"
    slim mad "No! Remember, the Rebellion is nearby. If we can find them, they may be able to help us."
...
label choice5:
    ...
    harry surprised "NO! Here is where we stand, here is where we fight back. If we run now, we will never stop running."


    slim proud "We must do what the Protector needs us to do. Stand together. Stand and fight!"
